...
console.log(addUserAddressUseCase("rhianmoura@email.com", "Rua Albino Costa", "1367", "Casa", "Divisa", "97573-290", "Santana do Livramento", "RS"));
console.log(addUserAddressUseCase("biaferreira@email.com", "Rua Farias Brito", "512", "Casa", "Fanny", "81030-120", "Barbalha", "CE"));
